!function(e, t) {
    ...
    h.extend = h.fn.extend = function() {
        ...
        a--); u > a; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = s[t],
                    s !== (r = e[t]) && (l && r && (h.isPlainObject(r) || (i = h.isArray(r))) ? (i ? (i = !1,
                    o = n && h.isArray(n) ? n : []) : o = n && h.isPlainObject(n) ? n : {},
                    s[t] = h.extend(l, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }
    ,
    h.extend({
        ...
        globalEval: function(e) {
            var t, n = eval;
            (e = h.trim(e)) && (1 === e.indexOf("use strict") ? ((t = p.createElement("script")).text = e,
            p.head.appendChild(t).parentNode.removeChild(t)) : n(e))
        },
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (y(Object(e)) ? h.merge(n, "string" == typeof e ? [e] : e) : o.call(n, e)),
            n
        },
        ...
        proxy: function(e, t) {
            ...
            t = e,
            e = n),
            h.isFunction(e) ? (i = r.call(arguments, 2),
            (o = function() {
    ...
    var x = function(e) {
        var t, n, r, i, o, s, a, u, l, c, f, p, d, h, g, m, v, y = "sizzle" + -new Date, x = e.document, b = 0, w = 0, T = re(), C = re(), N = re(), k = function(e, t) {
            return e === t && (l = !0),
            0
        }, E = "undefined", D = 1 << 31, j = {}.hasOwnProperty, S = [], A = S.pop, L = S.push, q = S.push, H = S.slice, O = S.indexOf || function(e) {
            for (var t = 0, n = this.length; n > t; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
        , F = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", P = "[\\x20\\t\\r\\n\\f]", M = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", R = M.replace("w", "w#"), W = "\\[" + P + "*(" + M + ")" + P + "*(?:([*^$|!~]?=)" + P + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + R + ")|)|)" + P + "*\\]", $ = ":(" + M + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + W.replace(3, 8) + ")*)|.*)\\)|)", B = new RegExp("^" + P + "+|((?:^|[^\\\\])(?:\\\\.)*)" + P + "+$","g"), I = new RegExp("^" + P + "*," + P + "*"), _ = new RegExp("^" + P + "*([>+~]|" + P + ")" + P + "*"), X = new RegExp("=" + P + "*([^\\]'\"]*?)" + P + "*\\]","g"), z = new RegExp($), U = new RegExp("^" + R + "$"), V = {
            ID: new RegExp("^#(" + M + ")"),
            CLASS: new RegExp("^\\.(" + M + ")"),
        ...
        function ne(e, t, r, i) {
            ...
            if ((t ? t.ownerDocument || t : x) !== f && c(t),
            t = t || f,
            r = r || [],
            !e || "string" != typeof e)
                return r;
                ...
                if (o = J.exec(e))
                    if (a = o[1]) {
                        ...
                        if ((a = o[3]) && n.getElementsByClassName && t.getElementsByClassName)
                            return q.apply(r, t.getElementsByClassName(a)),
                            r
                    }
                if (n.qsa && (!h || !h.test(e))) {
                    if (m = g = y,
                    ...
                    1 === u && "object" !== t.nodeName.toLowerCase()) {
                        for (p = de(e),
                        (g = t.getAttribute("id")) ? m = g.replace(Z, "\\$&") : t.setAttribute("id", m),
                        m = "[id='" + m + "'] ",
                        l = p.length; l--; )
                            p[l] = m + he(p[l]);
                    ...
                    if (w)
                        try {
                            return q.apply(r, b.querySelectorAll(w)),
                            r
                        } catch (e) {} finally {
        ...
        c = ne.setDocument = function(e) {
            var t, i = e ? e.ownerDocument || e : x, s = i.defaultView;
            ...
            g = [],
            h = [],
            (n.qsa = Q.test(i.querySelectorAll)) && (oe(function(e) {
            ...
            v = t || Q.test(p.contains) ? function(e, t) {
            ...
            : function(e, t) {
                if (e === t)
                    return l = !0,
                    0;
                var n, r = 0, o = e.parentNode, s = t.parentNode, a = [e], c = [t];
                if (!o || !s)
        ...
        (r = ne.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[5] && e[2];
                    return V.CHILD.test(e[0]) ? null : (e[3] && void 0 !== e[4] ? e[2] = e[4] : n && z.test(n) && (t = de(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, u) {
                        var l, c, f, p, d, h, g = o !== s ? "nextSibling" : "previousSibling", m = t.parentNode, v = a && t.nodeName.toLowerCase(), x = !u && !a;
                        if (m) {
                            if (o) {
                                for (; g; ) {
                                    for (f = t; f = f[g]; )
                            ...
                            s && x) {
                                ...
                                for (; (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++p || (x && ((f[y] || (f[y] = {}))[e] = [b, p]),
                                f !== t)); )
                                    ;
                ...
                PSEUDO: function(e, t) {
                    ...
                    r.setFilters.hasOwnProperty(e.toLowerCase()) ? ie(function(e, n) {
            ...
            pseudos: {
                ...
                lang: ie(function(e) {
                    return U.test(e || "") || ne.error("unsupported lang: " + e),
        ...
        function de(e, t) {
            ...
            u = [],
            l = r.preFilter; a; ) {
                for (s in (!n || (i = I.exec(a))) && (i && (a = a.slice(i[0].length) || a),
                u.push(o = [])),
                n = !1,
            ...
            ie(function(o, s, a, u) {
                var l, c, f, p = [], d = [], h = s.length, g = o || function(e, t, n) {
                    for (var r = 0, i = t.length; i > r; r++)
                        ne(e, t[r], n);
                    return n
                }(t || "*", a.nodeType ? [a] : a, []), m = !e || !o && t ? g : ve(g, p, e, a, u), v = n ? i || (o ? e : h || r) ? [] : s : m;
                if (n && n(m, v, a, u),
                r)
                    for (l = ve(v, d),
                    r(l, [], a, u),
                ...
                if (o) {
                    ...
                    v = ve(v === s ? v.splice(h, v.length) : v),
        ...
        function be(e, t) {
            var n = t.length > 0
              ...
              , o = function(o, s, u, l, c) {
                var p, d, h, g = 0, m = "0", v = o && [], y = [], x = a, w = o || i && r.find.TAG("*", c), T = b += null == x ? 1 : Math.random() || .1, C = w.length;
        ...
        function we(e, t, i, o) {
            ...
            if (!o && 1 === p.length) {
                ...
                for (a = V.needsContext.test(e) ? 0 : u.length; a-- && (l = u[a],
                !r.relative[c = l.type]); )
            ...
            return s(e, p)(o, t, !d, i, K.test(e) && fe(t.parentNode) || t),
            i
        }
    ...
    h.fn.extend({
        find: function(e) {
            ...
            for (t = 0; n > t; t++)
                h.find(e, i[t], r);
            return (r = this.pushStack(n > 1 ? h.unique(r) : r)).selector = this.selector ? this.selector + " " + e : e,
            r
        },
        filter: function(e) {
    ...
    (h.fn.init = function(e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (n[1]) {
                ...
                h.merge(this, h.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : p, !0)),
                w.test(n[1]) && h.isPlainObject(t))
                    for (n in t)
                        h.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
                return this
            }
            return (r = p.getElementById(n[2])) && r.parentNode && (this.length = 1,
            this[0] = r),
            this.context = p,
            this.selector = e,
            this
    ...
    h.Callbacks = function(e) {
        var t, n, r, i, o, s, a = [], u = !(e = "string" == typeof e ? L[e] || function(e) {
            ...
            t
        }(e) : h.extend({}, e)).once && [], l = function(f) {
            for (t = e.memory && f,
            n = !0,
            s = i || 0,
            i = 0,
    ...
    h.extend({
        ...
        when: function(e) {
            var t, n, i, o = 0, s = r.call(arguments), a = s.length, u = 1 !== a || e && h.isFunction(e.promise) ? a : 0, l = 1 === u ? e : h.Deferred(), c = function(e, n, i) {
                return function(o) {
                    n[e] = this,
    ...
    h.extend({
        ...
        ready: function(e) {
            ...
            !0 !== e && --h.readyWait > 0 || (S.resolveWith(p, [h]),
            h.fn.trigger && h(p).trigger("ready").off("ready")))
        }
    }),
    h.ready.promise = function(t) {
        return S || (S = h.Deferred(),
        "complete" === p.readyState ? setTimeout(h.ready) : (p.addEventListener("DOMContentLoaded", q, !1),
    ...
    O.prototype = {
        ...
        access: function(e, t, n) {
            var r;
            return void 0 === t || t && "string" == typeof t && void 0 === n ? void 0 !== (r = this.get(e, t)) ? r : this.get(e, h.camelCase(t)) : (this.set(e, t, n),
            void 0 !== n ? n : t)
        },
        remove: function(e, t) {
            ...
            if (void 0 === t)
                ...
                h.isArray(t) ? r = t.concat(t.map(h.camelCase)) : (i = h.camelCase(t),
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                ...
                1 === o.nodeType && !F.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--; )
                        0 === (r = s[n].name).indexOf("data-") && (r = h.camelCase(r.slice(5)),
                        W(o, r, i[r]));
    ...
    h.extend({
        queue: function(e, t, n) {
            ...
            r = F.get(e, t),
            n && (!r || h.isArray(n) ? r = F.access(e, t, h.makeArray(n)) : r.push(n)),
            r || []) : void 0
        },
    ...
    h.fn.extend({
        ...
        promise: function(e, t) {
            var n, r = 1, i = h.Deferred(), o = this, s = this.length, a = function() {
                --r || i.resolveWith(o, [o])
            };
    ...
    h.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (v)
                ...
                l = (t = (t || "").match(A) || [""]).length; l--; )
                    ...
                    f.setup && !1 !== f.setup.call(e, r, g, s) || e.addEventListener && e.addEventListener(d, s, !1)),
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(A) || [""]).length; l--; )
                    if (d = m = (a = Y.exec(t[l]) || [])[1],
                    g = (a[2] || "").split(".").sort(),
                    d) {
                        for (f = h.event.special[d] || {},
                        ...
                        s && !p.length && (f.teardown && !1 !== f.teardown.call(e, g, v.handle) || h.removeEvent(e, d, v.handle),
                        delete u[d])
                    } else
                        for (d in u)
                            h.event.remove(e, d + t[l], n, r, !0);
                h.isEmptyObject(u) && (delete v.handle,
                F.remove(e, "events"))
            }
        },
        trigger: function(t, n, r, i) {
            var o, s, a, u, c, f, d, g = [r || p], m = l.call(t, "type") ? t.type : t, v = l.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = r = r || p,
            3 !== r.nodeType && 8 !== r.nodeType && !V.test(m + h.event.triggered) && (m.indexOf(".") >= 0 && (m = (v = m.split(".")).shift(),
            v.sort()),
            c = m.indexOf(":") < 0 && "on" + m,
            ...
            i || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                ...
                for (o = 0; (s = g[o++]) && !t.isPropagationStopped(); )
                    ...
                    (f = c && s[c]) && f.apply && h.acceptData(s) && (t.result = f.apply(s, n),
                    !1 === t.result && t.preventDefault());
                return t.type = m,
                i || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(g.pop(), n) || !h.acceptData(r) || c && h.isFunction(r[m]) && !h.isWindow(r) && ((a = r[c]) && (r[c] = null),
                h.event.triggered = m,
                r[m](),
        ...
        dispatch: function(e) {
            e = h.event.fix(e);
            var t, n, i, o, s, a = [], u = r.call(arguments), l = (F.get(this, "events") || {})[e.type] || [], c = h.event.special[e.type] || {};
            if (u[0] = e,
            e.delegateTarget = this,
            !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
                for (a = h.event.handlers.call(this, e, l),
                t = 0; (o = a[t++]) && !e.isPropagationStopped(); )
                    ...
                    n = 0; (s = o.handlers[n++]) && !e.isImmediatePropagationStopped(); )
                        ...
                        e.data = s.data,
                        void 0 !== (i = ((h.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, u)) && !1 === (e.result = i) && (e.preventDefault(),
                        e.stopPropagation()));
            ...
            if (a && u.nodeType && (!e.button || "click" !== e.type))
                for (; u !== this; u = u.parentNode || this)
                    if (!0 !== u.disabled || "click" !== e.type) {
                        for (r = [],
                        n = 0; a > n; n++)
                            void 0 === r[i = (o = t[n]).selector + " "] && (r[i] = o.needsContext ? h(i, this).index(u) >= 0 : h.find(i, this, null, [u]).length),
                            r[i] && r.push(o);
                        r.length && s.push({
                            elem: u,
                            handlers: r
        ...
        fix: function(e) {
            ...
            for (s || (this.fixHooks[i] = s = U.test(i) ? this.mouseHooks : z.test(i) ? this.keyHooks : {}),
            r = s.props ? this.props.concat(s.props) : this.props,
            e = new h.Event(o),
            t = r.length; t--; )
                e[n = r[t]] = o[n];
            return e.target || (e.target = p),
    ...
    h.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.getPreventDefault && e.getPreventDefault() ? G : Q) : this.type = e,
        t && h.extend(this, t),
    ...
    h.each({
        ...
        h.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return (!r || r !== this && !h.contains(this, r)) && (e.type = i.origType,
    ...
    h.extend({
        clone: function(e, t, n) {
            var r, i, o, s, a = e.cloneNode(!0), u = h.contains(e.ownerDocument, e);
        ...
        buildFragment: function(e, t, n, r) {
            ...
            for (c.textContent = "",
            p = 0; i = f[p++]; )
                if ((!r || -1 === h.inArray(i, r)) && (u = h.contains(i.ownerDocument, i),
    ...
    h.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, r = e ? h.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
                ...
                n.parentNode && (t && h.contains(n.ownerDocument, n) && ce(pe(n, "script")),
                n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (h.cleanData(pe(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return H(this, function(e) {
                ...
                if ("string" == typeof e && !te.test(e) && !se[(Z.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; r > n; n++)
                            1 === (t = this[n] || {}).nodeType && (h.cleanData(pe(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        domManip: function(e, t) {
            e = i.apply([], e);
            var n, r, o, s, a, u, l = 0, c = this.length, p = this, d = c - 1, g = e[0], m = h.isFunction(g);
            ...
            if (c && (r = (n = h.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild,
            ...
            r)) {
                ...
                if (s)
                    ...
                    l = 0; s > l; l++)
                        a = o[l],
                        re.test(a.type || "") && !F.access(a, "globalEval") && h.contains(u, a) && (a.src ? h._evalUrl && h._evalUrl(a.src) : h.globalEval(a.textContent.replace(oe, "")))
            }
            return this
        }
    }),
    ...
    function ve(e) {
        var t = p
          , n = ge[e];
        return n || ("none" !== (n = me(e, t)) && n || ((t = (he = (he || h("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentDocument).write(),
        t.close(),
        n = me(e, t),
        he.detach()),
        ge[e] = n),
    ...
    function we(e, t, n) {
        ...
        n && ("" !== s || h.contains(e.ownerDocument, e) || (s = h.style(e, t)),
    ...
    !function() {
        var t, n, r = p.documentElement, i = p.createElement("div"), o = p.createElement("div");
        function s() {
    ...
    function Le(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)
            ...
            r ? ("content" === n && (s -= h.css(e, "padding" + B[o], !0, i)),
            "margin" !== n && (s -= h.css(e, "border" + B[o] + "Width", !0, i))) : (s += h.css(e, "padding" + B[o], !0, i),
            "padding" !== n && (s += h.css(e, "border" + B[o] + "Width", !0, i)));
        return s
    }
    function qe(e, t, n) {
        var r = !0
    ...
    function He(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
            ...
            "" === r.style.display && I(r) && (o[s] = F.access(r, "olddisplay", ve(r.nodeName)))) : o[s] || (i = I(r),
            (n && "none" !== n || !i) && F.set(r, "olddisplay", i ? n : h.css(r, "display"))));
        for (s = 0; a > s; s++)
    ...
    h.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = h.camelCase(t), u = e.style;
                return t = h.cssProps[a] || (h.cssProps[a] = Se(u, a)),
                s = h.cssHooks[t] || h.cssHooks[a],
                void 0 === n ? s && "get"in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t] : ("string" === (o = typeof n) && (i = ke.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(h.css(e, t)),
                o = "number"),
                void (null != n && n == n && ("number" !== o || h.cssNumber[a] || (n += "px"),
                f.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"),
                s && "set"in s && void 0 === (n = s.set(e, n, r)) || (u[t] = "",
                u[t] = n))))
            }
        },
        css: function(e, t, n, r) {
            var i, o, s, a = h.camelCase(t);
            return t = h.cssProps[a] || (h.cssProps[a] = Se(e.style, a)),
            (s = h.cssHooks[t] || h.cssHooks[a]) && "get"in s && (i = s.get(e, !0, n)),
            void 0 === i && (i = we(e, t, r)),
            "normal" === i && t in De && (i = De[t]),
            "" === n || n ? (o = parseFloat(i),
            !0 === n || h.isNumeric(o) ? o || 0 : i) : i
        }
    }),
    ...
    var Fe, Pe, Me = /^(?:toggle|show|hide)$/, Re = new RegExp("^(?:([+-])=|)(" + $ + ")([a-z%]*)$","i"), We = /queueHooks$/, $e = [function(e, t, n) {
        var r, i, o, s, a, u, l, c = this, f = {}, p = e.style, d = e.nodeType && I(e), g = F.get(e, "fxshow");
        for (r in n.queue || (null == (a = h._queueHooks(e, "fx")).unqueued && (a.unqueued = 0,
        u = a.empty.fire,
        ...
        "inline" === l && "none" === h.css(e, "float") && (p.display = "inline-block")),
    ...
    function ze(e, t, n) {
        var r, i, o = 0, s = $e.length, a = h.Deferred().always(function() {
            delete u.elem
        }), u = function() {
            if (i)
                return !1;
    ...
    h.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each(function() {
                var t, n = F.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = h.timers, s = r ? r.length : 0;
                for (n.finish = !0,
                h.queue(this, e, []),
    ...
    h.extend({
        attr: function(e, t, n) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o)
                return typeof e.getAttribute === X ? h.prop(e, t, n) : (1 === o && h.isXMLDoc(e) || (t = t.toLowerCase(),
                r = h.attrHooks[t] || (h.expr.match.bool.test(t) ? Ue : void 0)),
                void 0 === n ? r && "get"in r && null !== (i = r.get(e, t)) ? i : null == (i = h.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set"in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""),
        ...
        toggleClass: function(e, t) {
            ...
            : function() {
                if ("string" === n)
                    ...
                    (n === X || "boolean" === n) && (this.className && F.set(this, "__className__", this.className),
    ...
    h.fn.extend({
        val: function(e) {
            var t, n, r, i = this[0];
            return arguments.length ? (r = h.isFunction(e),
    ...
    h.parseXML = function(e) {
        ...
        return (!t || t.getElementsByTagName("parsererror").length) && h.error("Invalid XML: " + e),
        t
    }
    ;
    ...
    h.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var n, r, i, o, s, a, u, l, c = h.ajaxSetup({}, t), f = c.context || c, p = c.context && (f.nodeType || f.jquery) ? h(f) : h.event, d = h.Deferred(), g = h.Callbacks("once memory"), m = c.statusCode || {}, v = {}, y = {}, x = 0, b = "canceled", w = {
                readyState: 0,
            ...
            c.dataTypes = h.trim(c.dataType || "*").toLowerCase().match(A) || [""],
            ...
            c.ifModified && (h.lastModified[r] && w.setRequestHeader("If-Modified-Since", h.lastModified[r]),
            ...
            function T(e, t, o, a) {
                ...
                l ? (c.ifModified && ((T = w.getResponseHeader("Last-Modified")) && (h.lastModified[r] = T),
    ...
    h.ajaxPrefilter("json jsonp", function(t, n, r) {
        ...
        return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = h.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
        a ? t[a] = t[a].replace(Nt, "$1" + i) : !1 !== t.jsonp && (t.url += (Ke.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
        t.converters["script json"] = function() {
            return s || h.error(i + " was not called"),
            s[0]
        }
        ,
        t.dataTypes[0] = "json",
    ...
    h.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, s, a, u, l = h.css(e, "position"), c = h(e), f = {};
    ...
    h.fn.extend({
        offset: function(e) {
            ...
            h.contains(t, r) ? (typeof r.getBoundingClientRect !== X && (i = r.getBoundingClientRect()),
            n = Dt(o),
            {
    ...
    h.each(["top", "left"], function(e, t) {
        h.cssHooks[t] = Te(f.pixelPosition, function(e, n) {
            return n ? (n = we(e, t),
            xe.test(n) ? h(e).position()[t] + "px" : n) : void 0
        })
    }),
    h.each({
        Height: "height",
        ...
        h.each({
            ...
            h.fn[r] = function(r, i) {
                ...
                return H(this, function(t, n, r) {
                    ...
                    Math.max(t.body["scroll" + e], i["scroll" + e], t.body["offset" + e], i["offset" + e], i["client" + e])) : void 0 === r ? h.css(t, n, s) : h.style(t, n, r, s)
                }, t, o ? r : void 0, o, null)
            }
        })
    }),
