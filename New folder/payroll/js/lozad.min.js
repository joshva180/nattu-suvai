!function(t, e) {
    ...
    return function() {
        var e, n, i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : ".lozad", d = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, c = t({}, r, d), u = c.root, s = c.rootMargin, g = c.threshold, l = c.load, f = c.loaded, b = void 0;
        return window.IntersectionObserver && (b = new IntersectionObserver((e = l,
        n = f,
        function(t, r) {
            t.forEach(function(t) {
                (0 < t.intersectionRatio || t.isIntersecting) && (r.unobserve(t.target),
                a(t.target) || (e(t.target),
                o(t.target),
                n(t.target)))
            })
        }
